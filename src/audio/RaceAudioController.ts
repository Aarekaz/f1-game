...
export function raceAudioMix(telemetry: AudioTelemetry): RaceAudioMix {
  ...
  const slip = clamp01(
    Math.max(
      ...
      telemetry.loadTransferImpulse * 0.38,
      ...
      telemetry.counterSteerLoad * 0.52,
  ...
  return {
    ...
    tireFrequency:
      ...
      telemetry.loadTransferImpulse * 64 +
    ...
    tireGain: racing
      ? slip * 0.055 +
        ...
        telemetry.loadTransferImpulse * 0.008 +
        ...
        telemetry.tireCarcassFlex * 0.012 +
        telemetry.wheelHopLoad * 0.012 +
        ...
        telemetry.counterSteerLoad * 0.012 +
